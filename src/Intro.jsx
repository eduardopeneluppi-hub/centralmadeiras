...
export default function Intro({ onFinish }) {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center gap-10 overflow-hidden bg-white transition-opacity duration-700 ease-out ${
    ...
    >
      <img
        ...
        className="w-[720px] sm:w-[960px] drop-shadow-[0_8px_30px_rgba(0,0,0,0.15)] animate-[introLogo_1s_ease-out]"
      />

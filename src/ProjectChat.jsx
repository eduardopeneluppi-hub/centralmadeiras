...
import { WHATSAPP_NUMBER, brandGreenGradient } from './theme'
    ...
    <div className="relative z-10 -mt-10 rounded-t-[40px] bg-white pb-24 pt-16 shadow-[0_-25px_60px_-20px_rgba(0,0,0,0.25)] sm:pb-28 sm:pt-20">
      <section className="mx-auto w-full max-w-6xl px-6">
        ...
        <div className="mx-auto mt-14 w-full max-w-[380px]">
          ...
          <div
            className="mx-auto mt-8 flex h-20 w-20 items-center justify-center overflow-hidden rounded-full shadow-[0_10px_25px_-8px_rgba(46,125,50,0.55)]"
            style={{ background: brandGreenGradient }}
          >
            <img src={logoMark} alt="Central Madeiras" className="h-14 w-14 object-cover" draggable={false} />
          </div>
        </div>
      </section>
    </div>

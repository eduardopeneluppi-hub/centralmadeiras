    ...
    <div className="relative z-10 -mt-10 rounded-t-[40px] bg-white pb-24 pt-16 shadow-[0_-25px_60px_-20px_rgba(0,0,0,0.25)] sm:pb-28 sm:pt-20">
      <section className="mx-auto w-full max-w-6xl px-6">
        ...
        <div className="mx-auto mt-14 w-full max-w-[380px]">
          ...
          <a
            href="https://www.google.com/maps/search/?api=1&query=Avenida+Doutor+Lauro+Correa+da+Silva%2C+2225+-+Jardim+Roseira%2C+Limeira%2C+SP%2C+13480-625"
            target="_blank"
            rel="noopener noreferrer"
            className="group mx-auto mt-8 flex w-full max-w-[380px] items-center gap-3 rounded-[26px] border border-black/5 bg-white/90 p-4 shadow-[0_20px_40px_-24px_rgba(0,0,0,0.35)] backdrop-blur-xl transition active:scale-[0.98]"
          >
